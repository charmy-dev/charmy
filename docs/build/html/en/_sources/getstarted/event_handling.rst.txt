...
.. code-block:: python
   ...
   button = cm.Button(window, text="点我")
...
.. code-block:: python
   ...
   window = cm.Window(size=(400, 300))
   button = cm.Button(window, text="装饰器")
   button.place((50, 50), (120, 40))

   @button.on(cm.event_types.MouseClick)
   def handle_click(event):
       print(f"按钮在 {event.mouse_pos} 被点击了！")
...
.. code-block:: python
   ...
   def on_mouse_move(event):
       print(f"鼠标位置: {event.mouse_pos}")
       print(f"事件来源窗口: {event.subject}")
...
.. code-block:: python
   ...
   button.bind(cm.event_types.MouseEnter, lambda e: print("鼠标来了！"))
   button.bind(cm.event_types.MouseLeave, lambda e: print("鼠标走了！"))
...
.. code-block:: python
   ...
   window.bind(cm.event_types.WidgetResize, lambda e: print(f"窗口大小变为 {e.new_size}"))
   window.bind(cm.event_types.WidgetMove, lambda e: print(f"窗口移到 {e.new_pos}"))
   window.bind(cm.event_types.FocusGain, lambda e: print("窗口获得焦点"))
   window.bind(cm.event_types.FocusLoss, lambda e: print("窗口失去焦点"))

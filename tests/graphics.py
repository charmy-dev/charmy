...
# region Lines
test_polyline = cm.graphics.DrawnLine(cm.styles.shape.PolyLine([
...
test_rect = cm.graphics.DrawnShape(
    cm.styles.shape.Rect((300, 300), (100, 80)), (0, 255, 255), 3, (255, 0, 0)) .draw(window)

test_polygon = cm.graphics.DrawnShape(cm.styles.shape.AnyShape([cm.styles.shape.PolyLine([
